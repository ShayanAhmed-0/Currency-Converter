...
const PkrToDollar = () => {
    console.log("Your Ammount After Convertion Will be: ", Ammount * 0.0044);
};
const PkrToPounds = () => {
    console.log("Your Ammount After Convertion Will be: ", Ammount * 0.0035);
};
const DollarToPkr = () => {
    console.log("Your Ammount After Convertion Will be: ", Ammount * 230);
};
const DollarToPounds = () => {
    console.log("Your Ammount After Convertion Will be: ", Ammount * 0.81);
};
const PoundsToPkr = () => {
    console.log("Your Ammount After Convertion Will be: ", Ammount * 284.76);
};
const PoundsToDollar = () => {
    console.log("Your Ammount After Convertion Will be: ", Ammount * 1.24);
};
